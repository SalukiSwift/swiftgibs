...
# 2) strip a low-res data tree from the install (same as Windows/Linux; every
#    stock map baked in except the 11 campaign maps - tools/campaign-maps.txt).
SRC="$INSTALL" "$ROOT/tools/strip-assets.sh" "$STAGE/game"
